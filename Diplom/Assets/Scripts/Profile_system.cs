...
public class Profile_system : MonoBehaviour
{
    private List<Engine_options> options;
    public Options_configuration engine_options;
    ...
    private void Profile_add()
    {
        ...
        if (!string.IsNullOrWhiteSpace(created_name))
        {
            ...
            options.Add(new Engine_options(created_name, ""));
